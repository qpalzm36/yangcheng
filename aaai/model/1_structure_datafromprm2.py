...
# --- 文件路径配置 ---
PRM_INPUT_PATH = "/data/yangcheng/aaai/data/traindata/generatordata/sample_prm.jsonl"
STRUCTURED_OUTPUT_PATH = "/data/yangcheng/aaai/data/traindata/generatordata/sampled_testgenerate_structured.jsonl"
ERROR_LOG_FILE = "/data/yangcheng/aaai/data/traindata/generatordata/prm_structure_error_log.txt"
