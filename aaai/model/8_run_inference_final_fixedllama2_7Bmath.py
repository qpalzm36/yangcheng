...
def parse_args():
    ...
    parser.add_argument("--output_log_path", type=str, default="/data/yangcheng/aaai/resultsmath/inference_log_vllm_llama2_math500.jsonl", help="输出日志路径")
