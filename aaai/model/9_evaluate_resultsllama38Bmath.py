...
PROMPT_TEMPLATES = {
    "answer_accuracy": {
        "system": "You are a mathematical answer comparison expert. Your task is to determine if an AI-generated answer (Generated Answer) is mathematically equivalent to the standard answer (Gold Answer). Ignore differences in units, formatting, or trailing zeros. For example, '12' and '12.0' are equivalent. Return a JSON object containing only one key, 'is_correct', with a value of true or false.",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="运行Llama3 8B Math评估脚本")
    parser.add_argument("--inference_log_path", type=str, default="/data/yangcheng/aaai/resultsmath/inference_log_vllm_llama3_math500.jsonl", help="推理日志文件路径")
    parser.add_argument("--evaluation_report_path", type=str, default="/data/yangcheng/aaai/resultsmath/evaluation_report_math500llama38B.json", help="评估报告文件路径")
