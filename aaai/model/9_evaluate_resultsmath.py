...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="运行Math评估脚本")
    parser.add_argument("--inference_log_path", type=str, default="/data/yangcheng/aaai/resultsmath/inference_log_vllm_math500.jsonl", help="推理日志文件路径")
    parser.add_argument("--evaluation_report_path", type=str, default="/data/yangcheng/aaai/resultsmath/evaluation_report_math500qwen3B.json", help="评估报告文件路径")
