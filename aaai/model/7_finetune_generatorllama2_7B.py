    ...
    with open(input_data_path, 'r', encoding='utf-8') as f:
        for line in tqdm(f, desc="Parsing problems"):
            ...
            for step_num in sorted_step_nums:
                ...
                full_text1 = f"{prompt1} {decision_tag}</s>"
                ...
                full_text2 = f"{prompt2} {assistant_output}</s>"
...
# --- Main ---
def main():
    parser = argparse.ArgumentParser(description="微调Llama-2-7b-chat-hf生成器模型。")
    parser.add_argument("--base_model_path", type=str, default="/data/share_weight/Llama-2-7b-chat-hf", help="基础模型路径。")
    ...
    parser.add_argument("--output_dir", type=str, default="/data/yangcheng/aaai/generator_finetuned/Llama-2-7b-chat-hf", help="输出模型的保存目录。")
