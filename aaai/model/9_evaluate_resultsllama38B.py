...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="运行Llama3 8B评估脚本")
    parser.add_argument("--inference_log_path", type=str, default="/data/yangcheng/aaai/results/inference_log_vllm_llama3.jsonl", help="推理日志文件路径")
    parser.add_argument("--evaluation_report_path", type=str, default="/data/yangcheng/aaai/results/evaluation_report_llama3.json", help="评估报告文件路径")
