...
# --- 文件路径配置 ---
PRM_INPUT_PATH = "/data/yangcheng/aaai/data/traindata/structuredata/sample_prm.jsonl"
STRUCTURED_OUTPUT_PATH = "/data/yangcheng/aaai/data/traindata/structuredata/sampled_testbase_structured.jsonl"
ERROR_LOG_FILE = "/data/yangcheng/aaai/data/traindata/structuredata/prm_structure_error_log.txt"
