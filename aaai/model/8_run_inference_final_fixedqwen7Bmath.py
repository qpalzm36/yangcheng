    ...
    with open(args.test_set_path, 'r', encoding='utf-8') as f_in:
        ...
        for line in f_in:
            ...
            problem_data = {
                ...
                "answer": data["answer"]
                # 注意：MATH-500没有step-by-step的gold标准，所以不需要提取steps
            }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="运行Qwen7B MATH-500模型推理")
    ...
    parser.add_argument("--test_set_path", type=str, default="/data/yangcheng/MATH-500/test.jsonl", help="测试集路径")
    parser.add_argument("--output_log_path", type=str, default="/data/yangcheng/aaai/resultsmath/inference_log_math500_qwen7b.jsonl", help="输出日志路径")
