...
# --- Configuration ---
# BASE_MODEL_PATH = "/data/share_weight/Qwen2.5-3B-Instruct"
# INPUT_DATA_PATH = "/data/yangcheng/aaai/data/traindata/generatordata/generator_training_data_with_retrieval.jsonl"
# OUTPUT_DIR = "/data/yangcheng/aaai/generator_finetuned/Qwen-2.5-3B-Instruct"
...
# --- Main ---
def main():
    parser = argparse.ArgumentParser(description="微调Qwen2.5-3B-Instruct生成器模型。")
    parser.add_argument("--base_model_path", type=str, default="/data/share_weight/Qwen2.5-3B-Instruct", help="基础模型路径。")
    ...
    parser.add_argument("--output_dir", type=str, default="/data/yangcheng/aaai/generator_finetuned/Qwen-2.5-3B-Instruct", help="输出模型的保存目录。")
