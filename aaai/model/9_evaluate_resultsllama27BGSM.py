...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="运行Llama2 7B GSM评估脚本")
    parser.add_argument("--inference_log_path", type=str, default="/data/yangcheng/aaai/resultsGSM/inference_log_vllm_llama2_gsm8k.jsonl", help="推理日志文件路径")
    parser.add_argument("--evaluation_report_path", type=str, default="/data/yangcheng/aaai/resultsGSM/evaluation_report_gsm8kllama2.json", help="评估报告文件路径")
